package com.capstone.fresheats.ui.home.meat
...
class HomeMeatFragment : Fragment(), HomeListAdapter.ItemAdapterCallback {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        MeatsList = arguments?.getParcelableArrayList("data")

        val adapter = HomeListAdapter(MeatsList!!, this)
